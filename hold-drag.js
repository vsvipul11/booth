  ...
  tick: function() {
    if (this.internalState.dragging) {
      ...
      if (this.internalState.positionRaw) {
        ...
        const screenPositionZ = this.internalState.positionRaw.z / document.body.clientHeight * 2 - 1
        const screenPosition = new THREE.Vector2(screenPositionX, -screenPositionY , screenPositionZ)
